...
int main(int argc, char* argv[]) {
    ...
    pthread_create(&thread1, NULL, threadEnqueueDequeue, (void*)queue);
    pthread_create(&thread2, NULL, threadEnqueueDequeue, (void*)queue);
    pthread_create(&thread3, NULL, threadEnqueueDequeue, (void*)queue);

    for (int waitingThread = 0; waitingThread < numThreads; waitingThread++) {
